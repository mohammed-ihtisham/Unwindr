...
Deno.test("Action: inferPreferencesFromText interprets text and updates user preferences", async () => {
  ...
  try {
    ...
    // Temporarily override _callLLM to return many tags
    const originalCallLLM = concept["_callLLM"];
    concept["_callLLM"] = async (
      _text,
      _radius,
      _locationHint,
      _promptBuilder,
    ...
    concept["_callLLM"] = originalCallLLM; // Restore original implementation
