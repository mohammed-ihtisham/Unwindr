...
import QualityRankingConcept from "./QualityRanking/QualityRankingConcept.ts";
...
export type { default as QualityRankingConcept } from "./QualityRanking/QualityRankingConcept.ts";
...
export const QualityRanking = Engine.instrumentConcept(new QualityRankingConcept(db));
...
export const MediaLibrary = Engine.instrumentConcept(new MediaLibraryConcept(db));
