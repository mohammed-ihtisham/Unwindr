...
export interface PromptContext {
  text: string;
  allowedTags: Array<{ tag: string; description: string }>;
  radius?: number;
  locationHint?: string;
}
...
function allowedTagsTable(
  allowed: Array<{ tag: string; description: string }>,
): string {
 ...
 */
export const PROMPT_CONTRADICTIONS: PromptBuilder = ({
  text,
  allowedTags,
  radius,
  locationHint,
...
export const PROMPTS = {
  ...
  contradictions: PROMPT_CONTRADICTIONS,
};
