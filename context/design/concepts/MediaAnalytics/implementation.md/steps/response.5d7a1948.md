...
parent: '[[../20251017_163738.5796716c.md]]'
content_id: 5d7a1948562bc8781b72eeb4d16041a3eb89924bea3c8d5c05ecab4b70ae89e7
---

# response:

```typescript
// src/concepts/MediaAnalytics/MediaAnalyticsConcept.ts
...
const interactionWeights: Record<MediaInteractionDoc["interactionType"], number> = {
  "view": 1,
  "tap": 2,
  "like": 5,
  "share": 10,
...
export default class MediaAnalyticsConcept {
  ...
  async recordInteraction(
    ...
    const weight = interactionWeights[interactionType as MediaInteractionDoc["interactionType"]];
    ...
    const newInteraction: MediaInteractionDoc = {
      ...
      mediaItemId,
      userId,
      interactionType: interactionType as MediaInteractionDoc["interactionType"],
      ts: new Date(),
    };
