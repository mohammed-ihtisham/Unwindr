---
timestamp: 'Thu Oct 16 2025 21:09:10 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251016_210910.2204ab7d.md]]'
content_id: 66bf07f4624dfef2b5b75060b13bf87b564da4702d662d0ec1b88ac293ff47e3
---
...
export default class UserAuthConcept {
  ...
  async _getUserDetails(
    { userId }: { userId: User },
  ): Promise<Array<{ user: { username: string; canModerate: boolean } }> | {
    error: string;
  }> {
    ...
    return [{ user: { username: user.username, canModerate: user.canModerate } }];
  }
